 ...
 * Use the {@link ImageFragment_0#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ImageFragment_0 extends Fragment {

    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String TAG = ImageFragment_0.class.getSimpleName();
    ...
    public static ImageFragment_0 newInstance(int position, int imagesResourceIds) {
        ImageFragment_0 fragment = new ImageFragment_0();
